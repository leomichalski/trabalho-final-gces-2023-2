  ...
  var r,
    ...
    u = new (function () {
      ...
      (this.speak = (function (e) {
        function n() {
          Promise.resolve(e.apply(i.this, i.args))
            .then(i.fulfill)
            .catch(i.reject),
            (i = r = null);
        }
                ...
                n.length
                  ...
                  : ((t = !1),
                    (speechSynthesis.onvoiceschanged = function () {
                      t || ((t = !0), e(speechSynthesis.getVoices() || []));
                    }),
                    setTimeout(function () {
                      t || ((t = !0), e([]));
                    }, 3e3));
    ...
    c =
      (window.addEventListener("pagehide", u.stop.bind(u)),
    ...
    t =
      (Object.defineProperty(c, "isGoogleNative", {
        get: function () {
      ...
      Object.defineProperty(c, "effectiveRate", {
        get: function () {
          return this.rate * (this.isGoogleNative ? 0.9 : 1);
        },
      }),
      "IDLE"),
      ...
      n &&
        ...
        (o =
          "PLAYING" == e
            ...
            : o
                .then(function (e) {
                  return console.log("releasing wake lock"), e && e.release();
                })
                .then(function () {
                  return null;
                })));
  ...
  Object.defineProperty(this, "currentTime", {
    ...
    (this.play = function () {
      return "PAUSED" == t
        ...
        ? i.length
          ? (a >= i.length &&
              ((a = 0), s.dispatchEvent(new Event("timeupdate"))),
            l("PLAYING"),
            s.dispatchEvent(new Event("play")),
            (function e() {
              return r.speak(i[a], c, function () {
                a++,
                  ...
                  a < i.length
                    ? e()
                    : (l("IDLE"), s.dispatchEvent(new Event("ended"))),
                  desmarca();
              });
            })().then(function () {
              s.dispatchEvent(new Event("playing"));
    ...
    (this.pause = function () {
      !n && r.pause
        ? (r.pause(), l("PAUSED"), s.dispatchEvent(new Event("pause")))
        : s.stop();
    }),
    (this.stop = function () {
      r.stop(), l("IDLE"), s.dispatchEvent(new Event("pause"));
    });
  var d = {};
  function h(u, c) {
    function t(e) {
    ...
    function o(e) {
      for (
        var t = c.getWords(e), n = Math.min(Math.ceil(t.length / 2), u), o = [];
        t.length;

      )
        o.push(t.slice(0, n).join("")), (t = t.slice(n));
      return o;
    }
    function r(e, r) {
      function i() {
      ...
      return (
        e.forEach(function (e) {
          ...
          if (u < t) {
            i();
            for (var n = r(e), o = 0; o < n.length; o++) a.push(n[o]);
          } else s.wordCount + t > u && i(), s.parts.push(e), (s.wordCount += t);
        }),
        i(),
        a
      );
  ...
  function f() {
    function t(e, t) {
      for (var n = [], o = 0; o < e.length; o += 2) {
        ...
        r &&
          (t && n.length && t.test(n[n.length - 1])
            ? (n[n.length - 1] += r)
            : n.push(r));
      }
      return n;
...
function ReadAloudPlayer(o, t, a, e) {
  ...
  var n = a(".ra-btn-play", t),
    ...
    s =
      ...
      a(".ra-btn[data-toggle]").click(function () {
        ...
        return a(".ra-overlay", t).not(e).hide(), a(e).toggle(), !1;
      }),
      a(document).on("mouseup touchend touchcancel", function (e) {
        a(e.target).closest(".ra-btn[data-toggle], .ra-overlay").length ||
          a(".ra-overlay", t).hide();
      }),
      a(".ra-time-text", t)),
    u = a(".ra-error-text", t),
      ...
      h.on("mousedown touchstart", function () {
        return (
          ...
          T(
            ...
            function (e) {
              (r.seekKnob = !1), (o.currentTime = P(c, e) * o.duration);
            }
          ),
          !1
        );
  ...
  var p = a(".ra-rate-bg", t),
    ...
    g = a(".ra-rate-knob", t);
  function m(e) {
    (o.playbackRate = e), localStorage.setItem("sitespeakerRate", e);
  }
  p.click(function (e) {
  ...
  var y,
    w = a(".ra-volume-bg", t),
    b = a(".ra-volume-bar", t),
    E = a(".ra-volume-knob", t);
  function k(e) {
    (o.volume = e), localStorage.setItem("sitespeakerVolume", e);
  }
  w.click(function (e) {
    k(P(w, e));
  }),
      ...
      return (
        T(
          function (e) {
            var e = P(w, e),
              t = 100 * e + "%";
            E.css("left", t), b.css("width", t), n(e);
          },
          function () {
            r.volumeKnob = !1;
          }
    ...
    a(o).on("error", function () {
      a(t).addClass("ra-error"), u.text(o.error.message);
    }),
    ...
    a(o).on("timeupdate", function () {
      var e;
      r.seekKnob ||
        ((e = (100 * o.currentTime) / o.duration + "%"),
        h.css("left", e),
        d.css("width", e),
    ...
    a(o).on("ratechange", function () {
      var e;
      r.rateKnob ||
        ((e = 50 + (50 * Math.log(o.playbackRate)) / Math.log(2) + "%"),
        p.is(".ra-vertical")
          ? (g.css("bottom", e), v.css("height", e))
          : (g.css("left", e), v.css("width", e)));
    }),
    a(o).on("volumechange", function () {
      ...
      r.volumeKnob ||
        ((e = 100 * o.volume + "%"),
        w.is(".ra-vertical")
          ? (E.css("bottom", e), b.css("height", e))
          : (E.css("left", e), b.css("width", e)));
    }),
    o.isTTS &&
      (y = localStorage.getItem("sitespeakerVoice")) &&
      (n = o.voices.find(function (e) {
        return e.name == y;
      })) &&
      (o.voice = n);
  ...
  function S(e) {
    var t;
    o.isTTS
      ? s.text(Math.min(Math.round(e) + 1, o.duration) + "/" + o.duration)
      : s.text(
          "-" +
            ((e = o.duration - e),
            (t = Math.floor(e / 60)),
  ...
  function A(e, t) {
    ...
    function r() {
      (n = null), t.apply(o.this, o.args);
    }
  }
  n && (o.volume = Number(n)), a(o).triggerHandler("volumechange");
}
function ReadAloudDoc(i) {
  ...
  function l(e, t) {
    return e == document.body
      ? null
      : 1 == e.nodeType && !t && e.lastChild
      ? e.lastChild
      : e.previousSibling || l(e.parentNode, !0);
  }
  function d(e) {
    return e;
  }
  this.getTexts = function () {
    0 < i(".read-aloud").length ||
      (0 < i(".sitespeaker-read-aloud").length
        ? i(".sitespeaker-read-aloud").addClass("read-aloud")
        : ((e = (function (e) {
            for (var t = e.slice(0, 1), n = 1; n < e.length; n++)
              e[n] != e[n - 1] && t.push(e[n]);
            return t;
          })((e = i("p").not("blockquote > p").parent().get()))),
          (e = i(e).filter(":visible").get()).length
            ? ((n = e.map(function (e) {
    ...
    var n,
      o,
      e = i(".no-read-aloud:visible").hide(),
      t = (function (e) {
...
function readAloudInit(o, r, t, texto) {
  var i = o.getAttribute("data-lang"),
    ...
    l =
      "free" == a || s.startsWith("39d740e") ? new ReadAloudWebSpeech() : null;
  return r && t
    ? d().then(function () {
        var e = r.getElementsByClassName("ra-btn-play")[0],
          t = function () {
            e.removeEventListener("click", t),
              /iPad|iPhone|iPod/.test(navigator.userAgent) &&
                ((o.src =
                  "https://assets.readaloudwidget.com/embed/sound/silence.mp3"),
                o.play(),
                l &&
  ...
  function n() {
    ...
    return Promise.all([
      ...
      .then(function (e) {
        ...
        if (
          texto == "Olá, sou Voz Para Todos, uma ferramenta de acessibilidade."
        ) {
          ajuda = true;
        } else {
          ajuda = false;
        ...
        if (texto != "") {
          ...
          checkRead = false;
          var e =
            "function" == typeof readAloudGetText
              ? readAloudGetText(jQuery)
              : new ReadAloudDoc(jQuery).getTexts().join("\n\n");
        }
        ...
        return Promise.all([
                    ...
                    (n.onreadystatechange = function () {
                      4 == n.readyState &&
                        (200 == n.status
                          ...
                          : t(
                              new Error(
                                n.responseText || n.statusText || n.status
                              )
                            ));
                    }),
          ...
          r &&
            (t ? Promise.resolve() : d()).then(function () {
      ...
      .then(function (e) {
        ...
        n
          ? (jQuery(l).one("canplay", t), l.setText(e[0]), l.play())
          : (jQuery(o).one("canplay", t), (o.src = e[0]), o.play());
      });
  }
  function d() {
    var e,
      t = r.getAttribute("data-skin");
    return Promise.all([
      h(t + "/template.html"),
      ((t = t + "/styles.css"),
      ...
      n.open("GET", o, !0),
        (n.onreadystatechange = function () {
          4 == n.readyState &&
            (200 == n.status
              ? e(n.responseText)
              : t(new Error(n.responseText || n.statusText || n.status)));
        }),
        n.send(null);
    });
  }
